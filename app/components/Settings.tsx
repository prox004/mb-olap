    ...
    <div className="glass-card p-8 max-w-2xl mx-auto border border-[rgba(255,255,255,0.06)] bg-[rgba(15,15,20,0.85)] rounded-2xl space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h4 className="text-xs font-semibold text-white uppercase tracking-wider">Groq API Key</h4>
        </div>
        <div className="flex items-start gap-3 bg-emerald-500/5 border border-emerald-500/15 rounded-xl p-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-[#A1A1AA] leading-relaxed">
              The Groq API Key is securely loaded server-side from the <code className="bg-white/10 px-1.5 py-0.5 rounded font-mono text-purple-300 text-[10px]">.env</code> file.
              It is never exposed to the browser. To update the key, edit <code className="bg-white/10 px-1.5 py-0.5 rounded font-mono text-purple-300 text-[10px]">GROQ_API_KEY</code> in your <code className="bg-white/10 px-1.5 py-0.5 rounded font-mono text-purple-300 text-[10px]">.env</code> file and restart the server.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex items-center gap-3 bg-white/[0.03] border border-white/[0.06] rounded-xl p-3">
            ...
            <div>
              <p className="text-xs font-semibold text-white">Qwen 3.6 27B</p>
